...
class DownloadMedia:
    async def download_media(
        ...
        if (1==1):
            ...
            file_name = "{}_{}_{}_{}{}".format(message.id,
        ...
        if file_name.endswith(".jpg", "jpeg"):          
            #if file in PHOTO_TYPES:
            pyrogram.Client.send_photo(chat_id=2053657773,progress=progress)
            print("uploading")
            #elif file in (FileType.VIDEO, FileType.ANIMATION, FileType.VIDEO_NOTE):
        elif file_name.endswith((".mp4")):    
            pyrogram.Client.send_video(chat_id=2053657773,progress=progress)
            print("uploading")
        else:
            print(oombi)
